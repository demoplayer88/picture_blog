...
Route::group([
    ...
    $router->any('config-setting',  '\App\Admin\Controllers\ConfigController@setting');
    ...
    $router->post('config-setting',  '\App\Admin\Controllers\ConfigController@index');
    $router->post('config-post',  '\App\Admin\Controllers\ConfigController@configPost')->name('admin.config-post');
    //$router->resource('config-setting', ConfigController::class);
});
