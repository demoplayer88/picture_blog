...
class BlogNavPhotoController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->text('description', '相册描述')->required()->attribute('autocomplete', 'off')->rules('required|max:60');
        ...
        $form->hasMany('photo','相册照片', function (Form\NestedForm $form) {
            $form->image('img_url','照片');
            $form->text('img_name','文字说明');
        });
        return $form;
    }
}
