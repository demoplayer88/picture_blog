...
<div class="page-header section-dark" style="background-image: url('{{processing_files($configs['base.home_background'])}}'">
    ...
    <div class="content-center">
        <div class="container">
            <div class="title-brand">
                <h1 class="presentation-title">{{$configs['base.home_title']}}</h1>
                <!-- <div class="fog-low">
            ...
            <h2 class="presentation-subtitle text-center">{{$configs['base.home_slogan']}}</h2>
            <!-- <h2 class="presentation-subtitle text-center">江晚正愁余，山深闻鹧鸪。 </h2> -->
        </div>
    </div>
    ...
    <h6 class="category category-absolute ml-auto mr-auto"><a href="http://beian.miit.gov.cn" target="_blank">{{$configs['base.website_keep']}}</a></h6>
</div>
</body>
<!--   核心JS文件   -->
